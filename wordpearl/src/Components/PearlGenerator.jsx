  ...
  if (pearl === false) {
    ...
    return (
      <div className="generator-container">
        ...
        <button className="inspireme-button" onClick={handleClickPoem} >Inspire Me</button>
        {poem.length > 0 ? <div>
          <div className="inspireme">
            <ul>
              <br />
              <li className="poem-title">Title: {poem[0].title}, Author: {poem[0].author}</li>
              <br />
              <li className="poem-body">{poem[0].lines.slice(0, 10)}</li>
            </ul>
          </div>
        </div> : <></>}
      </div>
